...
class NewsPolicy
{
    ...
    {
        return $admin->can('delete_any_news');
    }
    ...
    {
        return $admin->can('force_delete_any_news');
    }
    ...
    {
        return $admin->can('restore_any_news');
    }

    /**
     * Determine whether the admin can replicate.
     */
    public function replicate(Admin $admin, News $news): bool
    {
        return $admin->can('replicate_news');
    }
