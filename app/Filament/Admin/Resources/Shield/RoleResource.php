...
namespace App\Filament\Admin\Resources\Shield;
...
class RoleResource extends Resource implements HasShieldPermissions
{
    ...
    {
        return [
            'index' => \App\Filament\Admin\Resources\Shield\RoleResource\Pages\ListRoles::route('/'),
            'create' => \App\Filament\Admin\Resources\Shield\RoleResource\Pages\CreateRole::route('/create'),
            'view' => \App\Filament\Admin\Resources\Shield\RoleResource\Pages\ViewRole::route('/{record}'),
            'edit' => \App\Filament\Admin\Resources\Shield\RoleResource\Pages\EditRole::route('/{record}/edit'),
        ];
    }
