...
use App\Filament\Admin\Resources\PaymentGatewayResource\RelationManagers;
...
class PaymentGatewayResource extends Resource
{
    ...
    protected static ?string $model = PaymentGateway\PaymentGateway::class;
                ...
                Forms\Components\Grid::make(3)->schema([
                    ...
                    Forms\Components\Grid::make(1)->schema([
                        Forms\Components\Section::make()->schema(
                            array_merge(
                                Filament::auth()->user()->can('change_author_payment-gateways') ? [
        ...
        return $table
            ...
            ->columns([
                ...
                Tables\Columns\TextColumn::make('status')
                    ...
                    ->label(__("Status"))
                    ->badge()
                    ->color(function (PaymentGateway\PaymentGateway $record){
                        return $record->status == Utilities::PUBLISHED ? "success" : "danger";
                    })
                    ->formatStateUsing(function(PaymentGateway\PaymentGateway $record){
